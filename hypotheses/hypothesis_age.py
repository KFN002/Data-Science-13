...
'''
H0: Между группами с опп и без него нет разницы в возрасте
'''
...
if shapiro(with_opp["возраст"])[1] >= 0.05 and shapiro(without_opp["возраст"])[1] >= 0.05:
    t_stat, p_value = ttest_ind(with_opp["возраст"], without_opp["возраст"], equal_var=False)
else:
    t_stat, p_value = mannwhitneyu(with_opp["возраст"], without_opp["возраст"])
