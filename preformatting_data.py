...
def preformat(df: pd.DataFrame):
    ...
    '''
    df["имт_кат"] = [0 if row["имт"] <= 16 else
                     1 if row["имт"] < 18.5 else
                     2 if row["имт"] < 25 else
                     3 if row["имт"] < 30 else
                     4 if row["имт"] < 35 else
                     5 if row["имт"] < 40 else
